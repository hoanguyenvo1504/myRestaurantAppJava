...
import com.example.androidmyrestaurant.Model.EventBus.CalculatePriceEvent;
...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.txt_pirce_new.setText(String.valueOf(finalResult));
    ...
    @BindView(R.id.txt_pirce_new)
    TextView txt_pirce_new;
